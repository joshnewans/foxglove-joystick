export function GamepadBackground(props: { themeName: string }): React.ReactElement {
  if (props.themeName === "steamdeck") {
    return (
      <>
        <g
          style={{
  ...
  } else if (props.themeName === "ipega-9083s") {
    return (
      <g>
        <path
  ...
  } else if (props.themeName === "cheapo") {
    return (
      <path
